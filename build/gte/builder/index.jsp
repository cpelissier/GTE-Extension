...
<body onload="javascript:prepareVars();">
			...
			<div id="flashContainer" style="height: 100%; position: absolute; top: 0px; left: 0px;" >			
				...
				<noscript>
					<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%" id="GuiBuilder">
						<param name="movie" value="GuiBuilder-201408210343.swf" />
						<param name="quality" value="high" />
						<param name="bgcolor" value="white" />
						<param name="allowFullScreen" value="true" />
						<param name="allowScriptAccess" value="always" />
						<!--[if !IE]>-->
						<object type="application/x-shockwave-flash" data="GuiBuilder-201408210343.swf" width="100%" height="100%">
							<param name="quality" value="high" />
							<param name="bgcolor" value="white" />
							<param name="allowFullScreen" value="true" />
							<param name="allowScriptAccess" value="always" />
    ...
    <div id="creditsContainer" style="display:none; font-size: 10px; font-family: Helvetica; text-align: left; margin: auto; background-color: #303030; color: #a0a0a0; padding: 3px 5px 3px 5px; border-left: 1px solid #303030; border-right: 1px solid #303030; width:500px;height:200px;">
		...
		<br/>
		<div>
		<div style="display: inline-block; margin-bottom: 5px;">Last modified: 2014-08-21 02:43 GMT</div><br/>
